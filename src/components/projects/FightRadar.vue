<template>
    <div class="w-screen h-lvh overflow-x-hidden" v-on:scroll="this.onScroll()">
        ...
        <div
            class="w-auto h-[100vh] z-10 relative md:ml-36 lg:ml-56 container p-8 space-y-20 items-center flex flex-col">
            <div class="p-6 sm:p-8 md:p-20 lg:p-24 bg-gray-950 bg-opacity-60 w-screen sm:w-full">
                    ...
                    <div class="relative">
                        <div class="relative z-10 grid grid-cols-1 sm:grid-cols-2 items-center gap-12">
                            <div class="space-y-6 sm:order-2">
                                ...
                                <div class="space-y-4">
                                    <a href="https://github.com/Giovi06/FightRadar"
                                        class="flex items-center space-x-4 p-4 hover:bg-gray-950 hover:bg-opacity-15 rounded z-20">
                                        <i class="pi pi-github text-4xl"></i>
                                        <div class="flex-1">
                                            <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-200">GitHub
                                            </h3>
                                            <p class="text-gray-600 dark:text-gray-400">Das gesamte Projekt im
                                                Repository.
                                            </p>
                                        </div>
                                    </a>
                                    <a href="javascript:void(0);"
                                        ...
                                        <div class="flex-1">
                                            <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-200">Projekt
                                                Video
                                            </h3>
                                            <p class="text-gray-600 dark:text-gray-400">Ein Überblick über unser
                                                Projekt.
                                            </p>
                                        </div>
                                    </a>
            ...
            <div class="p-6 sm:p-8 md:p-20 lg:p-24 bg-gray-950 bg-opacity-60 w-screen sm:w-full">
                ...
                <section :id="sections[1].id">
                    <div>
                        <h3 class="py-1 text-md sm:text-md md:text-lg font-semibold text-center">Zielsetzung</h3>
                        <ul>
                        ...
                        <h3 class="py-1 text-md sm:text-md md:text-lg font-semibold text-center">Rahmenbedingungen</h3>
                        <ul>
                    ...
                    <div>
                        <h4 class="pt-4 text-md sm:text-md md:text-lg font-semibold text-center"> ProjektOrganisation
                        </h4>
                        <ul>
                            <li class="py-3">Projektleiter: Giovanni Innamorato</li>
                            <li class=" text-md font-semibold py-2">Projektmitglieder:
                                <ul class=" font-normal text-sm">
                                    <li class="pt-1 py-0.5  pl-1">Giuliano Martullo</li>
                                    <li class="pb-0.5 pl-1">Sathana Suganthasri</li>
                                    <li class="pb-0.5 pl-1">Gabriel Bischof</li>
                                </ul>
                            </li>
                            <li class="pt-2 pb-1">Projektstart: 01.09.2021</li>
                            <li class=" pb-2">Projektende: 15.12.2023</li>
                        </ul>
                    </div>
                </section>
            </div>
            <div class="p-6 sm:p-8 md:p-20 lg:p-24 bg-gray-950 bg-opacity-60 w-screen sm:w-full">
                ...
                <section :id="sections[2].id">
                    <div>
                        <p>Bevor wir mit der Entwicklung der Webanwendung beginnen, ist es wichtig, eine solide
                            Wissensgrundlage über die verwendeten Technologien zu schaffen. Für die Frontend-Entwicklung
                            mit
                            React.js werden wir uns auf eine Kombination aus Dokumentation und Lehrvideos stützen.</p>

                        <h4>Dokumentation und Tutorial</h4>
                        <ul>
                            <li>Die offizielle React-Dokumentation auf <a href="https://react.dev/">react.dev</a> wird
                                unser
                                Hauptanlaufpunkt für fundierte Informationen und Best Practices sein.</li>
                            <li>Die Erstellung und Verwaltung von NoSQL-Datenbanken sowie die API-Entwicklung sind
                                entscheidend für die Datenverarbeitung unserer Anwendung. Hierzu werden wir folgende
                                Ressourcen nutzen</li>
                            <li class="relative pt-[56.25%] overflow-hidden my-4"><iframe
                                    class=" absolute top-0 left-0 w-full h-full"
                                    src="https://www.youtube.com/embed/jJK9alBkzU0?si=vvsItKAYyDvaE4Rn"
                                    title="YouTube video player" frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></li>
                            <li class="relative pt-[56.25%] overflow-hidden my-4"><iframe
                                    class=" absolute top-0 left-0 w-full h-full"
                                    src="https://www.youtube.com/embed/WRuQ-BOoy5c?si=WYcw4kWnk8I0DiHK"
                                    title="YouTube video player" frameborder="0"
                                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                                    referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe></li>
                        </ul>
            ...
            <div class="p-6 sm:p-8 md:p-20 lg:p-24 bg-gray-950 bg-opacity-60 w-screen sm:w-full">
                ...
                <section :id="sections[3].id">
                    <div>
                        ...
                        <p class="mb-4">
                            Die Systemgrenzen definieren, welche Teile des Systems innerhalb des Projekts liegen und
                            welche
                            ausserhalb. Für das Projekt der Entwicklung einer "Tinder-ähnlichen" Web-Anwendung zum
                            gemeinsamen Problemlösen, können die Systemgrenzen wie folgt beschrieben werden:
                        </p>
                        ...
                        <p class="mb-4">
                            Schnittstellen beschreiben, wie das System mit externen Systemen oder Komponenten
                            interagiert.
                            Für dieses Projekt sind folgende Schnittstellen relevant:
                        </p>
                        <h2 class="text-md font-semibold mb-2">Benutzerschnittstelle:</h2>
                        <ul class="list-disc list-inside mb-4">
                            <li>Frontend (React.js): Die Schnittstelle, über die Benutzer mit der Anwendung
                                interagieren.
                            </li>
                    ...
                    <div class="w-auto">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mb-4 text-sm sm:text-base">
                                Zuerst müssen wir die relevanten Kriterien definieren, anhand derer wir die beiden
                                Alternativen bewerten wollen:
                            </p>
                            <ul class="list-disc list-inside space-y-2 text-sm sm:text-base">
                                ...
                                <li>Flexibilität: Wie gut kann die Lösung an zukünftige Anforderungen angepasst werden?
                                </li>
                            ...
                            <ul class="mt-4 list-none p-0 mx-0">
                                <li class="flex align-items-center pb-3">
                                    <span style="width:1rem;height:1rem"
                                        class="border-round bg-indigo-500 mr-3 flex-shrink-0"></span>
                                ...
                                <li class="flex align-items-center py-3">
                                    <span style="width:1rem;height:1rem"
                                        class="border-round bg-blue-500 mr-3 flex-shrink-0"></span>
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mb-4 text-sm sm:text-base">
                                Auf Grundlage der Punkte, die sich aus der Gewichtung und den Bewertungen ergeben, hat
                                React
                                mit 78 Punkten besser abgeschnitten als JS/HTML mit 65 Punkten.
                            </p>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-sm sm:text-base">
                                Basierend auf der Nutzwertanalyse ist React die sinnvollere Wahl für unser Projekt. Es
                                bietet eine bessere Performance, ist wartbarer, flexibler und benutzerfreundlicher im
                                Vergleich zu JS/HTML. Auch wenn die Entwicklungszeit möglicherweise etwas höher ist,
                                überwiegen die langfristigen Vorteile wie bessere Wartbarkeit und Flexibilität. Daher
                                haben
                                wir uns entschieden, React anstelle von JS/HTML zu verwenden.
                            </p>
                        </div>
                    </div>
                </section>
            </div>
            <div class="p-4 sm:p-8 md:p-20 lg:p-24 bg-gray-950 bg-opacity-60 w-screen sm:w-full">
                <h2 class="text-xl sm:text-xl md:text-5xl font-semibold text-center text-gray-800 my-6">{{
                    sections[5].name
                    }}</h2>
                    ...
                    <div class="surface-section px-4 py-8 md:px-6 lg:px-8 text-700">
                        <div class="flex flex-wrap">
                            ...
                            <div class="w-full lg:w-6 pr-0 lg:pr-5">
                                ...
                                <div class="font-normal text-2xl mt-3 mb-3 text-900">Grundgerüst der Datenbank
                                </div>
                                <p class="line-height-3 mt-0 mb-5">
                                    Hier werde ich erklären, wie ich die Verbindung zur MongoDB erstellt habe.
                                </p>

                                <ImageModal src="/FightRadar/AppsettingsJSON.png"
                                    alt="Code snippet showing MongoDB connection setup" />
                                ...
                                <div class="mb-6">
                                    ...
                                    <p class="mb-2">Der Name der Datenbank, die verwendet wird. Hier ist es FightRadar.
                                    </p>
                                </div>
                                <div class="mb-6">
                                ...
                                <div class="mb-6">
                                    ...
                                    <p class="mb-2">
                                        Dies gibt an, welche Hosts die Anwendung annehmen darf. Der Wert * bedeutet,
                                        dass
                            ...
                            <div class="w-full lg:w-6 pl-0 lg:pl-5 pt-5">
                                <ImageModal src="/FightRadar/ProgramCS-Screen.png"
                                    alt="Program.cs implementation code snippet" />
                                <div class="mt-3 text-center text-sm font-medium mb-5">Program.cs Implementierung</div>
                                ...
                                <p class="line-height-3 mt-0 mb-5">
                                    Die Konfigurationseinstellungen für die Datenbank (FightRadarDatabaseSettings)
                                    werden
                                    aus der appsettings.json-Datei gelesen und zur Verfügung gestellt. Ein
                                    Singleton-Dienst
                                    für die UserService-Klasse wird hinzugefügt, damit diese Klasse später im Code
                                    verwendet
                                    werden kann. CORS (Cross-Origin Resource Sharing) wird konfiguriert, um alle
                                    Ursprünge,
                                    Methoden und Header zu erlauben. Das ermöglicht es, dass die API von verschiedenen
                                    Domänen
                                    aus angesprochen werden kann. Die Controller der Anwendung werden hinzugefügt und
                                    JSON-Optionen
                                ...
                                <p class="line-height-3 mb-5">
                                    ...
                                    Datenbank gespeichert werden: <strong>Fight.cs</strong>,
                                    <strong>FightRadarDatabase.cs</strong> und
                                    <strong>User.cs</strong>.
                                </p>

                                <ImageModal src="/FightRadar/FightCS-Screen.png" alt="Fight.cs code snippet" />
                                <div class="mt-3 text-center text-sm font-medium mb-5">Fight.cs Implementierung</div>

                                <div class="mb-6">
                                    <h3 class="text-md font-semibold mb-2">Fight.cs:</h3>
                                    <p class="mb-2">
                                        In der "Fight.cs" definieren wir die Struktur eines Kampfes und eines Matches in
                                        unserer
                                        Anwendung. <br />
                                        <strong>Opponent:</strong> Informationen über den Gegner, wie z. B. Username und
                                        Id.
                                        <br />
                                ...
                                <ImageModal src="/FightRadar/FightRadar-DB-Settings-Screen.png"
                                    alt="FightRadarDatabaseSettings.cs code snippet" />
                                <div class="mt-3 text-center text-sm font-medium mb-5">FightRadarDatabaseSettings.cs
                                    Implementierung</div>

                                <div class="mb-6">
                                    <h3 class="text-md font-semibold mb-2">FightRadarDatabaseSettings.cs:</h3>
                                    <p class="mb-2">
                                        Die Klasse "FightRadarDatabaseSettings.cs" ist eine Konfigurationsklasse, die
                                        verwendet wird, um
                                        die Verbindungsinformationen zur MongoDB-Datenbank zu halten. Diese
                                        Informationen
                                        werden aus der
                                        appsettings.json-Datei geladen und enthalten typischerweise:
                                        <br />
                                        <strong>ConnectionString:</strong> Die URL zur MongoDB-Datenbank, einschließlich
                                        Hostname und
                                        Portnummer. <br />
                                        <strong>DatabaseName:</strong> Der Name der MongoDB-Datenbank, in der die Daten
                                        gespeichert werden. <br />
                                        <strong>CollectionName:</strong> Der Name der MongoDB-Sammlung (Collection), in
                                        der
                                        bestimmte Dokumente
                                ...
                                <ImageModal src="/FightRadar/UserCS-Screen.png" alt="User.cs code snippet" />
                                <div class="mt-3 text-center text-sm font-medium mb-5">User.cs Implementierung</div>

                                <div class="mb-6">
                                    <h3 class="text-md font-semibold mb-2">User.cs:</h3>
                                    <p class="mb-2">
                                        In der "User.cs" definieren wir die Struktur eines Benutzerobjekts für unsere
                                        Anwendung. Es werden die
                                        Eigenschaften eines Benutzers festgelegt, die in der MongoDB-Datenbank
                                        gespeichert
                                        werden sollen.
                                        <br />
                                        <strong>Id:</strong> für die eindeutige Kennung des Benutzers. <br />
                                        <strong>Username:</strong> Der Benutzername des Benutzers. <br />
                                        <strong>Password:</strong> Das Passwort des Benutzers (in der Regel
                                        verschlüsselt
                                        gespeichert). <br />
                                        <strong>Email:</strong> Die E-Mail-Adresse des Benutzers. <br />
                                        <strong>Matches:</strong> Eine Liste von Kämpfen oder Matches, die der Benutzer
                                        gespeichert hat. <br />
                                        Weitere Eigenschaften wie Gewicht, Erfahrungen, Kampfstil und Gewichtsklasse
                                        könnten
                                        ebenfalls Teil des Benutzerprofils sein.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="p-6 sm:p-8 md:p-20 lg:p-24 bg-gray-950 bg-opacity-60 w-screen sm:w-full">
                <h2 class="text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold text-center text-gray-800 my-6">
                    {{ sections[6].name }}
                </h2>
                <section :id="sections[6].id" class="w-full">
                    <div class="w-full">
                        <h1 class="text-lg sm:text-xl md:text-2xl font-bold mb-4">Reflexion über die Arbeit</h1>
                        <p class="mb-4">
                            Als Team haben wir hervorragend zusammengearbeitet und konnten größtenteils dem Plan folgen.
                            Dennoch stellte sich das Produkt als sehr herausfordernd heraus, und die zur Verfügung
                            stehende Zeit reichte nicht aus, um es vollständig zu implementieren. Trotz dieser
                            Herausforderungen konnten wir jedoch die fehlenden Elemente in der Dokumentation erfolgreich
                            vervollständigen. Dies zeigt unsere Fähigkeit, uns flexibel auf die Gegebenheiten
                            einzustellen und wichtige Aufgaben effektiv abzuschließen.
                        </p>

                        <h1 class="text-lg sm:text-xl md:text-2xl font-bold mb-4">Schlusswort</h1>
                        <p class="mb-4">
                            Zum Schluss möchten wir ein paar Worte zu unserem Projekt sagen. Die Arbeit an unserem
                            "FightRadar" hat uns persönlich viel Freude bereitet und war eine herausfordernde, aber
                            lohnenswerte Erfahrung. Als Team haben wir gut zusammengearbeitet und unsere
                            unterschiedlichen Fähigkeiten und Perspektiven eingebracht, um das Projekt erfolgreich zu
                            gestalten. Wir freuen uns darauf, unsere Arbeit und die Ergebnisse des "FightRadar"
                            gemeinsam zu präsentieren und zu diskutieren.
                        </p>
                    </div>
                </section>
            </div>
            <div class="p-6 sm:p-8 md:p-20 lg:p-24 bg-gray-950 bg-opacity-60 w-screen sm:w-full">
                ...
                <section :id="sections[7].id">
                    <div>
                        <p>Man kann ein Konto erstellen und sich anschliessend damit einloggen. Nach erfolgreichem Login
                            sieht man direkt auf der Startseite ein neues Match, das man nach Belieben annehmen oder
                            ablehnen kann. Bei jeder Annahme wird das Match für beide Benutzer auf der Matches-Seite
                            angezeigt. Dort besteht auch die Möglichkeit, Matches zu löschen. Die Matches werden mit
                            einem zufälligen zukünftigen Datum versehen.</p>
                    </div>
                    <div class="relative pt-[56.25%] overflow-hidden">
                        <iframe class=" absolute top-0 left-0 w-full h-full"
                            src="https://www.youtube.com/embed/AvYb3qMwCOA?si=5pB0yLwfnaFbIPiv"
                            title="YouTube video player" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
...
export default {
    data() {
        return {
            sections: [
                { id: '0', name: 'FightRadar' },
                { id: '1', name: "Aufgabenstellung" },
                { id: '2', name: "Informieren" },
                { id: '3', name: "Planen" },
                { id: '4', name: "Entscheiden" },
                { id: '5', name: "Realisieren" },
                { id: '6', name: "Auswertung" },
                { id: 'video', name: 'Projekt Video' },
            ],
            activeSection: '',
            navVisible: true,
            FightRadar: {
