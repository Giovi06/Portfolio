    ...
    <div class="surface-section px-4 py-8 md:px-6 lg:px-8 text-700">
      <div class="flex flex-wrap">
        ...
        <div class="w-full lg:w-6 pr-0 lg:pr-5">
          ...
          <ImageModal src="/FightRadar/AppsettingsJSON.png" alt="Code snippet showing MongoDB connection setup" />
        ...
        <div class="w-full lg:w-6 pl-0 lg:pl-5 pt-5">
          <ImageModal src="/FightRadar/ProgramCS-Screen.png" alt="Program.cs implementation code snippet"/>
          ...
          <ImageModal src="/FightRadar/FightRadar-DB-Settings-Screen.png" alt="FightRadarDatabaseSettings.cs code snippet" />
          <div class="mt-3 text-center text-sm font-medium mb-5">FightRadarDatabaseSettings.cs Implementierung</div>
